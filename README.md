...
* SIM900 GSM module
* Power supply for SIM900- 9V, 1A adapter was used for testing, other adapters could work
* SIM card with data/internet bundle or ability to access the internet
